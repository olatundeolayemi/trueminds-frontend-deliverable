    ...
    <>
      <style>{`
        ...
        * {
        ...
        .signup-footer .footer-col {
          flex: 0 0 auto;
          min-width: 120px;
        }

        .signup-footer .footer-col strong {
          display: block;
          margin-bottom: 14px;
          color: #fff;
          font-weight: 700;
        ...
        .signup-footer .footer-col a:hover {
          color: #f6b081;
        }

        .signup-footer .logo-small {
          font-family: "Island Moments", cursive;
          color: #f6b081;
          font-size: 20px;
          margin-bottom: 16px;
          ...
          <section className="signup-right">
            ...
            <div className="signup-form-wrapper">
              ...
              <form onSubmit={handleContinue}>
                ...
                <div className="signup-note" style={{marginBottom: '60px'}}>
            ...
            {/* FOOTER */}
            <footer className="signup-footer" role="contentinfo">
              ...
              <div className="signup-copyright">©2024 Chuks Kitchen. All rights reserved.</div>
            </footer>
          </section>
        </div>
      </div>
